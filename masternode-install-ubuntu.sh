...
COIN_TGZP='https://github.com/smnccoin/smnc/releases/download/v1001/SMNC-Linux-1001.zip'
COIN_BOOTSTRAP='https://github.com/smnccoin/smnc/releases/download/v1001/Bootstrap.zip'
